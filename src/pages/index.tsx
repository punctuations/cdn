...
export default function Home() {
    ...
    return (
        <div className={styles.container}>
            ...
            >
                <FileDrop
                    className={`transition-shadow duration-500 m-20 p-32 rounded-md border-4 ${drag ? 'border-solid' : 'border-dashed'} hover:border-solid ${uploadError ? 'border-red-300' : 'border-gray-200'} hover:shadow-2xl cursor-pointer`}
